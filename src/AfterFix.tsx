...
const AfterFix = ({ hook }: { hook: BayesHook }): JSX.Element => {
  ...
  return (
    <Box>
      ...
      <Typography>
        However, that doesn't take into account how much data we have collected
        and what certainty that gives us (e.g. that calculation would return the
        same result for 1 failure in 10 runs at it would for 100 failures in
        1000 runs)
      </Typography>
      <Typography>
